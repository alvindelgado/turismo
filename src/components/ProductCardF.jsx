...
function ProductCardF() {
  return (
    <><h1>Promocion 2x1</h1><p class="descripcion">Vente de viaje tú y la persona que tú prefieras, por la mitad de precio! Porque cada semana actualizamos una selección de las mejores ofertas de viaje 2x1, con un acompañante gratis o con un descuento para el segundo acompañante.</p>
